...
export default function Screen4Validation({ onTransmit }) {
  return (
    <div className="space-y-6">
      ...
      <div className="luxury-card p-5 flex flex-wrap items-center gap-4">
        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[var(--primary-navy)] to-[var(--primary-navy-2)] text-white flex items-center justify-center font-bold text-lg">AH</div>
        <div>
          <div className="font-semibold text-[var(--text-heading)]">Amira Hadj</div>
          <div className="text-xs text-[var(--text-muted)]">Dossier N° DS-4471 · NIR 290 128 44 782 005</div>
        </div>
      ...
      <div className="flex flex-col sm:flex-row sm:justify-end gap-3 pt-2">
        ...
        <button onClick={onTransmit} className="btn-gold text-base px-6 py-3">
